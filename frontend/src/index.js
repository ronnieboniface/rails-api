...
const authorInfo = document.querySelector('.right');
...
const fetchAuthors = async () => {
  const authorsFetch = await fetch(baseUrl);
  const authors = await authorsFetch.json();
  console.log(authors)
...
//   authorInfo.appendChild(formDiv);
